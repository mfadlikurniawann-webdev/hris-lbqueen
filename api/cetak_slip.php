...
$total_penerima = $gaji_pokok + $uang_makan + $uang_kerajinan + $uang_bonus + $uang_lembur;
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        ...
        .signature-box .sign-area img.sig-ttd { 
            height: 75px; 
            position: relative; 
            z-index: 1; 
            opacity: 1; 
        }
        .signature-box .sign-area img.sig-cap { 
            position: absolute; 
            height: 100px; 
            left: 50%; 
            top: 50%; 
...
<body>
    ...
    <div class="container">
        <div class="header">
            <img src="../public/logo/lbqueen_logo.PNG" alt="Logo">
        ...
        <div class="signature-box">
            ...
            <div class="sign-area">
                <img src="../public/logo/Cap_LBQueen.png" class="sig-cap" alt="Cap">
                <img src="../public/logo/ttd.png" class="sig-ttd" alt="Sign">
            </div>
