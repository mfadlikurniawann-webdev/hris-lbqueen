...
if ($jenis === 'lembur') {
    ...
    if ($conn->query($sql)) echo "✅ Pengajuan Lembur berhasil dikirim!"; else echo "❌ Gagal: " . $conn->error;
    ...
    if ($conn->query($sql)) echo "✅ Pengajuan $kat berhasil dikirim!"; else echo "❌ Gagal: " . $conn->error;
    ...
    if ($conn->query($sql)) echo "✅ Pengajuan Dinas berhasil dikirim!"; else echo "❌ Gagal: " . $conn->error;
    ...
    if ($conn->query($sql)) echo "✅ Pengajuan Reimburse berhasil dikirim!"; else echo "❌ Gagal: " . $conn->error;
} else {
