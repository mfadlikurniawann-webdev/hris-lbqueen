...
if ($jenis === 'dinas') {
    ...
    $sql = "INSERT INTO perjalanan_dinas (nik, tujuan, tgl_berangkat, tgl_kembali, keterangan) VALUES ('$nik', '$tujuan', '$berangkat', '$kembali', '$ket')";
    ...
    $sql = "INSERT INTO reimburse (nik, kategori, nominal, keterangan, foto_nota) VALUES ('$nik', '$kategori', $nominal, '$ket', '$foto')";
    ...
    $sql = "INSERT INTO lembur (nik, tanggal, jam_mulai, jam_selesai, keterangan) VALUES ('$nik', '$tanggal', '$jam_mulai', '$jam_selesai', '$keterangan')";
    if ($conn->query($sql)) echo "✅ Rencana Lembur berhasil diajukan!";
    else echo "❌ Gagal: " . $conn->error;
}
?>